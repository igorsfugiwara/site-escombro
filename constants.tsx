...
export const INITIAL_HERO = {
  ...
  subtitle: 'Pesado, direto e sem concessões contra a hipocrisia e o preconceito.',
  imageUrl: 'https://res.cloudinary.com/dcfifapdf/image/upload/v1775172695/Escombro_2025_-_jowhead-51_gvco4d.jpg'
};
